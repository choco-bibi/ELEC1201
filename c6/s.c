...
while(1)
{
	...
	uint8_t af = (PINC & _BV(PC1));
	 ...
	 if(ai == 0 && bi == 0 && af == 0 && bf == 1) {
	  i--;
	 }
	 if(ai == 0 && bi == 1 && af == 1 && bf == 1) {
	  i--;
	 }
	 if(ai == 1 && bi == 0 && af == 0 && bf == 0) {
	  i--;
	 }
	 if(ai == 1 && bi == 1 && af == 1 && bf == 0) {
	  i--;
	 }
	 if(ai == 0 && bi == 0 && af == 1 && bf == 0) {
	  i++;
	 }
	 if(ai == 0 && bi == 1 && af == 0 && bf == 0) {
	  i++;
	 }
	 if(ai == 1 && bi == 0 && af == 1 && bf == 1) {
	  i++;
	 }
	 if(ai == 1 && bi == 1 && af == 0 && bf == 1) {
	  i++;
	 }
	if (i>9){
			i=0;
